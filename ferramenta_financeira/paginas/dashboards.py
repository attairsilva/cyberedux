...
st.write(f'#### :money_with_wings:  TOTAL DE DESPESAS ')
st.write(f'####  {totaldespesas:,.2f}')
...
st.write(f'#### :dollar: TOTAL DE RECEITAS ')
st.write(f'#### R$ {totaldereceitas:,.2f}')

diferenca =  totaldereceitas - totaldespesas

st.write(f'#### :moneybag: SOBRAS PARA O PERÍODO ')
st.write(f'####  R$ {diferenca:,.2f}')
